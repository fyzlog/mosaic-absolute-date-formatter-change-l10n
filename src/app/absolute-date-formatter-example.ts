...
import { DateAdapter, DateFormatter, MC_LOCALE_SERVICE, McLocaleService } from '@ptsecurity/mosaic/core';
...
export class AbsoluteDateFormatterExample {
    ...
    constructor(
        ...
        @Inject(MC_LOCALE_SERVICE) private localeService: McLocaleService
    ) {
